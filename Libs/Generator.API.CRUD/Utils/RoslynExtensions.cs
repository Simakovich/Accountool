...
namespace D9bolic.Generator.API.CRUD.Utils
{
    public static class RoslynExtensions
    {
        ...
        public static AttributeSyntax GetAttribute(this TypeDeclarationSyntax typeDeclaration,
            ISet<string> attributesName)
        ...
        public static Dictionary<string, ITypeSymbol> GetProperties(this INamedTypeSymbol symbol) => symbol
            .GetAllMembers()
